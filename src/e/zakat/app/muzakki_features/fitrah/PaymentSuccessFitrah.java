 ...
 * @author user
 */
public class PaymentSuccessFitrah extends javax.swing.JFrame {

    /**
     * Creates new form OnboardingOne
     */
    public PaymentSuccessFitrah() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaymentSuccessFitrah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaymentSuccessFitrah().setVisible(true);
            }
        });
    }
