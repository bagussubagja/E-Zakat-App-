 ...
 * @author bagus
 */
public class ChoosePaymentFitrah extends javax.swing.JFrame {

    /**
     * Creates new form LoginMuzakki
     */
    public ChoosePaymentFitrah() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChoosePaymentFitrah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChoosePaymentFitrah().setVisible(true);
            }
        });
    }
