 ...
 * @author user
 */
public class PaymentSuccessMaalMuzakki extends javax.swing.JFrame {

    /**
     * Creates new form OnboardingOne
     */
    public PaymentSuccessMaalMuzakki() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaymentSuccessMaalMuzakki.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaymentSuccessMaalMuzakki().setVisible(true);
            }
        });
    }
