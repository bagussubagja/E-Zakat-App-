 ...
 * @author bagus
 */
public class TransferBankMuzakki extends javax.swing.JFrame {

    /**
     * Creates new form LoginMuzakki
     */
    public TransferBankMuzakki() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransferBankMuzakki.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TransferBankMuzakki().setVisible(true);
            }
        });
    }
