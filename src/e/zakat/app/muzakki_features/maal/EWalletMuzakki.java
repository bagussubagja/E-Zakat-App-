 ...
 * @author bagus
 */
public class EWalletMuzakki extends javax.swing.JFrame {

    /**
     * Creates new form LoginMuzakki
     */
    public EWalletMuzakki() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EWalletMuzakki.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EWalletMuzakki().setVisible(true);
            }
        });
    }
