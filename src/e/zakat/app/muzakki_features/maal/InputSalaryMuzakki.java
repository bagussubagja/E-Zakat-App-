 ...
 * @author bagus
 */
public class InputSalaryMuzakki extends javax.swing.JFrame {

    /**
     * Creates new form LoginMuzakki
     */
    public InputSalaryMuzakki() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InputSalaryMuzakki.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InputSalaryMuzakki().setVisible(true);
            }
        });
    }
