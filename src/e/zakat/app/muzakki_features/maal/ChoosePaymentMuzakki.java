 ...
 * @author bagus
 */
public class ChoosePaymentMuzakki extends javax.swing.JFrame {

    /**
     * Creates new form LoginMuzakki
     */
    public ChoosePaymentMuzakki() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChoosePaymentMuzakki.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChoosePaymentMuzakki().setVisible(true);
            }
        });
    }
